...
public class HBaseUtilsImpl implements HBaseUtils {
    ...
    private static final String ZK_CONNECT_VALUE = "172.168.0.64:2181,172.168.0.64:2181,172.168.0.64:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //hbu.putData("user_info", "user0001", "base_info", "name", "zhangsan1",new Date().getTime());
        hbu.getAllTables();
