...
import org.clm.javaproject.http.HttpComponent;
...
public class JunitTest{
    private static String person_classname = "org.clm.javaproject.reflect.Person";
    private static String superperson_classname = "org.clm.javaproject.reflect.SuperPerson";
    ...
    public static void Test2() throws ClassNotFoundException {
        ...
        class1 = Class.forName(person_classname);
    ...
    public static void Test7() throws ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Class<?> class1 = null;
        class1 = Class.forName(superperson_classname);
