package javaproject.thread.readfile;
...
public class ReadFile2 {
    ...
    private ReadFile2(File file, IHandle handle, String charset, int bufferSize, int threadSize){
    ...
    public static class Builder {
        ...
        public ReadFile2 build() {
            return new ReadFile2(this.file, this.handle, this.charset, this.bufferSize, this.threadSize);
        }
    }
    ...
    public static void main(String[] args) {
        Builder builder = new Builder("d:/reliability.txt",new IHandle() {
        ...
        ReadFile2 bigFileReader = builder.build();
        bigFileReader.start();
    }
}
